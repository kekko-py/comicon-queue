        ...
        if is_couple:
            if self.queue_couples:
                ...
                if self.queue_singles:
                    ...
                    self.next_player_name = self.get_player_name(self.next_player_id) if self.next_player_id else None
                    self.next_player_locked = True if self.next_player_id else False
            else:
